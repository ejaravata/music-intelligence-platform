...
app.get('/billboard/song/:id', routes.billboard_song_stats)
app.get('/billboard/artist/:id', routes.billboard_artist_stats)
app.get('/grammys/song/:id', routes.grammys_song_stats);
app.get('/grammys/artist/:id', routes.grammys_artist_stats);
